...
from . import serverinfo_chat_message_pb2 as serverinfo__chat__message__pb2
...
Response_ViewLogHistory = _reflection.GeneratedProtocolMessageType('Response_ViewLogHistory', (_message.Message,), dict(
